  ...
  return (
    <div className="home p-4">
      ...
      <div className="flex mt-4">
        ...
        <div className="ml-6">
          myForum est un projet réalisé dans le cadre d'un stage en Software
          Engineering au sein de l'entreprise Namkin afin de se familiariser
          avec les technologies utilisées dans le cadre du développement de la
          plateforme SaaS Olympe. <br />
          <br />
          Bonne visite !
        </div>
      </div>

      {accesstoken ? <LoggedDashboard /> : <NotLoggedDashboard />}
    </div>
  );
}
